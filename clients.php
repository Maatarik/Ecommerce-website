...
echo"<h1><center> veuiller saisir l id du client a supprimmer</center></h1>";
...
$res=mysqli_query($lien,$sql);
 ...
 echo"</select><br><br>
<input type='submit' name='sb' value='supprimer'><input type='submit' name='ter' value='terminer'>
</form></center>
";
